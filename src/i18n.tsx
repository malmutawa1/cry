...
const en: Dict = {
  ...
  'nav.rush': 'Rush',
  'nav.account': 'Account',
  'rush.page.title': 'Need it fast?',
  'rush.page.sub': 'Skip the queue — choose a speed and we’ll rush it through.',
  'rush.book': 'Book now',
  'rush.unavailable': 'Unavailable today',
  'rush.benefit.express': 'Jump ahead of standard orders — ready by tomorrow.',
  'rush.benefit.urgent': 'We start immediately — ready in a few hours today.',
  'rush.page.note': 'Rush fees are one-time and charged on top of your plan.',
...
const ar: Dict = {
  ...
  'nav.rush': 'عاجل',
  'nav.account': 'حسابي',
  'rush.page.title': 'تحتاجه بسرعة؟',
  'rush.page.sub': 'تخطَّ الطابور — اختر السرعة وسنُسرّع طلبك.',
  'rush.book': 'احجز الآن',
  'rush.unavailable': 'غير متاح اليوم',
  'rush.benefit.express': 'تجاوز الطلبات العادية — جاهز غداً.',
  'rush.benefit.urgent': 'نبدأ فوراً — جاهز خلال ساعات اليوم.',
  'rush.page.note': 'رسوم الاستعجال لمرة واحدة وتُضاف فوق باقتك.',
