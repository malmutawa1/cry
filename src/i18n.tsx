...
const en: Dict = {
  ...
  'onboard.title': 'Urgent Service Delivery',
  'onboard.sub': 'We work on a crowdsourcing model. You place an order, the system selects the perfect time for you.',
...
const ar: Dict = {
  ...
  'onboard.title': 'خدمة توصيل عاجلة',
  'onboard.sub': 'نعمل بنموذج جماعي. تضع طلبك، ويختار النظام الوقت المثالي لك.',
  'onboard.cta': 'ابدأ الآن',
